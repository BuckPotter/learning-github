...
public:
    ...
    CTIME Chuan_Hoa();     // Chuẩn hóa, dùng để chuẩn hóa kết quảsau khi cộng, trừ 2 thời điểm
    void Cong(int);        // Cộng vào thời điểm đang xét một số nguyên giây
    void Tru(int);         // Trừ vào thời điểm đang xét một số nguyên giây
